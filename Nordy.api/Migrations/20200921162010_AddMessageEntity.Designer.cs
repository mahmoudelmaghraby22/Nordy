...
namespace Nordy.API.Migrations
{
    ...
    [Migration("20200921162010_AddMessageEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Nordy.API.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Nordy.API.Models.Message", b =>
                {
                    b.HasOne("Nordy.API.Models.User", "Recipient")
                        .WithMany("MessageReceived")
                        .HasForeignKey("RecipientId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Nordy.API.Models.User", "Sender")
